...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($exists == false) {
        $qry = "INSERT INTO `customertbl` (`name`, `contactno`, `address`, `email`, `password`) VALUES ('$name', '$contact', '$address', '$email', '$password')";
        ...
        <div class="container">
            <div class="row no-gutters">
                <div class="form-content col-lg-7 px-5 pt-5">
                    ...
                    <h4 class="py-1">Create a new customer account</h4>
                    <form method="post" action="">
                        <div class="form-row">
                            <div class="col-lg-7">
                                <input type="text" placeholder="Enter Your Full Name" class="form-control" required="true" name="name">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-lg-7">
                                <input type="text" placeholder="Contact Number" class="form-control" required="true" name="contact">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-lg-7">
                                <input type="text" placeholder="Address" class="form-control" required="true" name="address">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-lg-7">
